...
const Register = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    if (verifyOtpCode.fulfilled.match(resultAction) && resultAction.payload?.success) {
      setSuccessMessage(resultAction.payload.message || 'Registration completed successfully.');
      ...
      <div className="glass-panel" style={styles.card}>
        ...
        {showOtpStep && (
          <div style={styles.otpSection}>
            ...
            />
            <button type="button" className="btn-primary" onClick={handleVerifyOtp} style={styles.submitBtn}>
              Verify OTP
            </button>
