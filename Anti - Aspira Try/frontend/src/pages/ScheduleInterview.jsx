...
const styles = {
  ...
  clockFace: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle at center, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.05) 45%, rgba(0,0,0,0.25) 100%)",
    border: "2px solid rgba(255,255,255,0.12)",
    boxShadow:
      "0 25px 50px rgba(0,0,0,.45), inset 0 0 40px rgba(255,255,255,.05)",
    overflow: "hidden",
  },
  clockCenter: {
    position: "absolute",
  ...
  selectedClockSlot: {
    ...
    boxShadow: "0 0 30px rgba(79,140,255,.55)",
    color: "#fff",
  },
  timeSummary: {
    color: "#fff",
